  ...
  useEffect(() => {
    const loadCourses = async () => {
      try {
        ...
        setErrorMessage('Failed to load your courses. You can still invite a student without selecting a course.');
      } finally {
      ...
      <div className="bg-gradient-to-r from-[#27AE60]/20 via-[#16A085]/20 to-[#2980B9]/20 rounded-xl p-6 border border-[#27AE60]/30 shadow-lg">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-stone-800">Invite a Student</h1>
              <p className="text-stone-600 mt-1 text-sm">
                Send an invitation so learners can join your classes and start learning.
              </p>
            </div>
          </div>
          <button
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <p className="mt-1 text-xs text-stone-500">
                The student will be able to sign in with this email and accept your invitation.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-stone-500 flex items-center gap-1.5">
                ...
                If you select a course, accepting the invite will automatically enroll the student.
              </p>
            </div>

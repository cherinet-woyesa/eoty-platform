        ...
        <div className="flex items-center justify-center min-h-64">
          <div className="text-center bg-white/90 backdrop-blur-md rounded-lg p-6 border border-red-200 shadow-sm max-w-sm">
            ...
            <button
              ...
              className="inline-flex items-center px-3 py-1.5 text-white rounded-lg hover:shadow-md transition-all font-medium text-xs"
    ...
    <div className="max-w-7xl mx-auto space-y-6 p-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <Link
          ...
          className="inline-flex items-center px-4 py-2 text-white rounded-lg hover:opacity-90 transition-all font-medium text-sm shadow-sm"
          style={{ backgroundColor: brandColors.primaryHex }}
        >
        ...
        <div className="bg-white rounded-xl p-5 border border-gray-200 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            <div className="p-2 rounded-lg" style={{ backgroundColor: `${brandColors.primaryHex}15` }}>
              <FileText className="h-5 w-5" style={{ color: brandColors.primaryHex }} />
            </div>
          </div>
                ...
                >
                  ...
                  <div className="space-y-3 mb-4">
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className={`font-semibold ${isOverdue ? 'text-red-600' : daysUntilDue <= 3 ? 'text-amber-600' : 'text-gray-700'}`}>
                    ...
                    {assignment.averageScore && (
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <span className="font-semibold text-green-600">{assignment.averageScore}%</span>
                      </div>
                    )}
                    ...
                    <div className="mt-2">
                      ...
                      <div className="w-full bg-gray-100 rounded-full h-2">
                        <div
                          ...
                          style={{ width: `${progress}%`, backgroundColor: brandColors.primaryHex }}
                        ></div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-2 pt-4 border-t border-gray-100">
                    <Link
                      ...
                      className="flex-1 inline-flex items-center justify-center px-4 py-2 text-white rounded-lg transition-all shadow-sm hover:shadow-md font-medium text-sm"
                      style={{ backgroundColor: brandColors.primaryHex }}
                    >
                    ...
                    <Link
                      ...
                      className="inline-flex items-center px-4 py-2 bg-white hover:bg-gray-50 border border-gray-200 text-gray-700 rounded-lg transition-all font-medium text-sm"
                    >
          ...
          <div className="text-center py-16 bg-white rounded-xl border border-gray-200 shadow-sm">
            ...
            {!searchTerm && statusFilter === 'all' && (
              <Link
                ...
                className="inline-flex items-center px-4 py-2 text-white rounded-lg hover:shadow-lg transition-all font-medium"
                style={{ backgroundColor: brandColors.primaryHex }}
              >
                <Plus className="h-4 w-4 mr-2" />

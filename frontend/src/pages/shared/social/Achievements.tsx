      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 sm:gap-6 mb-8">
        <div className="bg-white rounded-xl p-6 border border-gray-200 text-center">
          <div className="flex items-center justify-center mb-2">
            <Medal className="h-6 w-6 text-gray-900 mr-2" />
            <div className="text-3xl font-bold text-gray-900">{earnedBadgesCount}</div>
          </div>
          <div className="text-sm text-gray-500 font-medium">Badges Earned</div>
        </div>
        
        <div className="bg-white rounded-xl p-6 border border-gray-200 text-center">
          <div className="flex items-center justify-center mb-2">
            <Sparkles className="h-6 w-6 text-gray-900 mr-2" />
        ...
        <div className="bg-white rounded-xl p-6 border border-gray-200 text-center">
          <div className="flex items-center justify-center mb-2">
            ...
            <div className="text-3xl font-bold text-gray-900">{averagePoints}</div>
          </div>
          <div className="text-sm text-gray-500 font-medium">Avg Points/Badge</div>
        </div>

        <div className="bg-white rounded-xl p-6 border border-gray-200 text-center">
          <div className="flex items-center justify-center mb-2">
            <Crown className="h-6 w-6 text-gray-900 mr-2" />

...
const DashboardSkeleton: React.FC = () => {
  return (
    <div className="w-full space-y-3 p-3 sm:p-4 lg:p-6 bg-gradient-to-br from-stone-50 via-neutral-50 to-slate-50 min-h-screen animate-pulse">
      ...
      <div className="bg-white/50 rounded-lg p-4 border border-stone-200 shadow-sm h-24">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="bg-white/50 rounded-lg p-4 border border-stone-200 shadow-sm h-32 flex flex-col justify-between">
      ...
      <div className="bg-white/50 rounded-lg shadow-sm border border-stone-200 p-4">

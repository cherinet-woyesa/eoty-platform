    ...
    <div className="bg-white rounded-lg shadow-md p-6">
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6 gap-4">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage and organize content with tags</p>
        </div>
      ...
      {showCreateForm && (
        <form onSubmit={handleCreateTag} className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-lg mb-6 border border-blue-200">

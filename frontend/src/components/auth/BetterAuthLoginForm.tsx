...
const BetterAuthLoginForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('✅ Better Auth login successful');
      setSuccessMessage('Welcome back! Redirecting to your dashboard...');
      
      // Navigate using React Router (Better Auth handles session via cookies)
      setTimeout(() => {
      ...
      } else if (err.message?.includes('deactivated') || err.message?.includes('inactive')) {

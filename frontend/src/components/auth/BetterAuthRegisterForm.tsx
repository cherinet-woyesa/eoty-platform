...
const BetterAuthRegisterForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Use legacy registration endpoint that works with integer IDs
      ...
      if (result.user) {
        ...
        console.log('✅ User stored in localStorage:', result.user.email);
      }
...
export default BetterAuthRegisterForm;

        ...
        <div className="relative z-10">
          <div className="flex items-start justify-between mb-3">
            <div className="flex items-center">
              ...
              <h3 className="font-bold text-lg tracking-tight">Welcome, {userName}!</h3>
            </div>
            <button
              onClick={() => {
                setIsVisible(false);
          ...
          <p className="text-sm mb-5 leading-relaxed text-white/90 font-medium">
            Ready to start your spiritual learning journey? Complete our quick guide to unlock all features.
          </p>

          {/* Benefits */}
          <div className="bg-black/10 backdrop-blur-sm rounded-xl p-4 mb-5 border border-white/10">
            <div className="text-[10px] uppercase tracking-wider font-bold mb-3 text-white/60">Unlock These Benefits</div>
            <div className="grid grid-cols-2 gap-3 text-xs">
              <div className="flex items-center">
                <Gift className="h-3.5 w-3.5 mr-2 text-yellow-300" />
                <span className="font-medium">Welcome Rewards</span>
              </div>
              <div className="flex items-center">
              ...
              <div className="flex items-center">
                ...
                <span className="font-medium">Quick 2-min Guide</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex gap-3">
            ...
            >
              <span className="mr-2">🚀</span> Start Journey
            </button>
            <button
              onClick={() => {
                setIsVisible(false);
